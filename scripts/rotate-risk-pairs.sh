...
COIN_NEWS_DB_TARGET="${COIN_NEWS_DB_URL:-${COIN_NEWS_DB_PATH:-postgresql+psycopg2://${STACK_POSTGRES_USER:-stack}:${STACK_POSTGRES_PASSWORD:-stack}@stack-postgres:5432/${STACK_ANALYTICS_DB:-stack_analytics}}}"
COIN_NEWS_MAX_AGE_MINUTES="${COIN_NEWS_MAX_AGE_MINUTES:-180}"
...
metrics_json="$(
  prepare_cmd=(
    ...
    -e COIN_NEWS_ENABLED="${COIN_NEWS_ENABLED}"
    -e COIN_NEWS_DB_URL="${COIN_NEWS_DB_TARGET}"
    -e COIN_NEWS_MAX_AGE_MINUTES="${COIN_NEWS_MAX_AGE_MINUTES}"
